...
export default function Footer() {
  ...
  return (
    ...
    <footer className='block lg:hidden sticky bottom-0 mt-auto font-times font-light text-base text-primary-700* text-yellow-600 w-screen -ml-5 sm:-ml-24 bg-yellow-200'
    ...
    className='group '>
      ...
      <p className='leading-5 px-5 sm:px-24'><span className='bf'>ADITYA DAS</span> © 2023</p>
      <p className='mb-1 leading-5 px-5 sm:px-24'> Coded with <span className='bf'>React, NextJS, TailwindCSS, FramerMotion, & TypeScript</span> / Fonts: <span className='bf'>ABC Favorit</span>, Times New Roman, & <span className='font-abcdiatype font-normal text-[.9rem]'>ABC Diatype</span>
      </p>
    ...
    className='group'>
      <hr className="solid border-primary-0 pb-1"></hr>
      <div className='mb-1 leading-5 px-5 sm:px-24 w-full flex justify-between'>
