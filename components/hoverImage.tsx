                    ...
                    <motion.div
                        ...
                        <div className='fixed flex flex-col gap-y-1 items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-fit '>
                            <motion.div 
                                ...
                                {(hoverContent[2] || hoverContent[3]) && <p className={`px-1 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 uppercase whitespace-nowrap z-20 text-basefavorit font-abcfavorit text-primary-100 bg-secondary-0 `}>
                                    {!hoverContent[2] && "PAGE COMING SOON"}
                                </p>}
                            </motion.div>

                            <p className='min-w-full px-2 block text-center font-times text-base text-primary-100  z-50'>{hoverContent[3].substring(2)}</p>
