...
export default function Page() {
  return (
    <>
      ...
      <div className='w-auto aspect-video max-h-full my-1.5'>
        <iframe 
          width="560"
          height="315" 
          src="https://www.youtube.com/embed/GPSEP8xgVMI?si=tY0EiFn0wUKEZavL" 
